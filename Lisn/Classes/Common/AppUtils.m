...
+(AFHTTPSessionManager*)getAFHTTPSessionManager{
    ...
    //[serializer setValue:@"application/x-www-form-urlencodedn" forHTTPHeaderField:@"Content-Type"];
    //[serializer setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Accept"];
